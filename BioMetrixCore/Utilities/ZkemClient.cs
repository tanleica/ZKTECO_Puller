...
namespace BioMetrixCore
{
    public class ZkemClient : IZKEM
    {
        ...
        public void ObjCZKEM_OnEnrollFinger(int EnrollNumber, int FingerIndex, int ActionResult, int TemplateLength)
        {
            ...
            Console.WriteLine("ObjCZKEM_OnEnrollFinger");
        ...
        public bool SetCommuTimeOut(int x)
        {
            throw new NotImplementedException();
        }

        public bool SendFileByType(int x, string y, int z)
        {
            throw new NotImplementedException();
        }
        public bool SetCommProType(int x)
        {
            throw new NotImplementedException();
        }

        public bool SetCompatOldFirmware(int x)
        {
            throw new NotImplementedException();
        }

        public bool Connect_P4P(string x)
        {
            throw new NotImplementedException();
        }

        public bool SetDeviceTableData(int x, string y, string z, string a, out int b)
        {
            throw new NotImplementedException();
        }

        public void GetConnectStatus(ref int x)
        {
            throw new NotImplementedException();
        }

        public bool SetManufacturerData(int x, string y, string z)
        {
            throw new NotImplementedException();
        }

        public int GetDeviceStatusEx(int x)
        {
            throw new NotImplementedException();
        }
        ...
        public int SSR_GetDeviceDataCount(string a, string b, string c)
        {
            throw new NotImplementedException();
        }

        public bool SSR_DeleteDeviceData(int x, string a, string b, string c)
        {
            throw new NotImplementedException();
        }

        public bool ReadTimeGLogData(int a, string b, string c)
        {
            throw new NotImplementedException();
        }

        public bool DeleteAttlogBetweenTheDate(int a, string b, string c)
        {
            throw new NotImplementedException();
        }

        public bool DeleteAttlogByTime(int a, string b)
        {
            throw new NotImplementedException();
        }

        public bool GetBellSchDataEx(int a, int b, int c, out int d, out int e, out int f, out int g, out int h, out int i, out int j) { throw new NotImplementedException(); }
        public bool ReadNewGLogData(int a) { throw new NotImplementedException(); }
        public bool IsNewFirmwareMachine(int a) { throw new NotImplementedException(); }
        public bool UploadUserPhoto(int a, string b) { throw new NotImplementedException(); }
        public bool DownloadUserPhoto(int a, string b, string c) { throw new NotImplementedException(); }
        public bool DeleteUserPhoto(int a, string b) { throw new NotImplementedException(); }
        public bool GetAllUserPhoto(int a, string b) { throw new NotImplementedException(); }
        public bool SetBellSchDataEx(int a, int b, int c, int d, int e, int f, int g, int h, int i, int j) { throw new NotImplementedException(); }
        public bool GetDayBellSchCount(int a, out int b) { throw new NotImplementedException(); }
        public bool GetMaxBellIDInBellSchData(int a, out int b) { throw new NotImplementedException(); }
        public bool ReadAllBellSchData(int a) { throw new NotImplementedException(); }
        public bool GetEachBellInfo(int a, out int b, out int c, out int d, out int e, out int f, out int g, out int h, out int i, out int j) { throw new NotImplementedException(); }
        public bool SetUserValidDate(int a, string b, int c, int d, string e, string f) { throw new NotImplementedException(); }
        public bool GetUserValidDate(int a, string b, out int c, out int d, out string e, out string f) { throw new NotImplementedException(); }
        public bool SetUserValidDateBatch(int a, string b) { throw new NotImplementedException(); }
        public bool GetUserValidDateBatch(int a, out string b, int c) { throw new NotImplementedException(); }
        public bool SetUserVerifyStyle(int a, string b, int c, ref byte d) { throw new NotImplementedException(); }
        public bool GetUserVerifyStyle(int a, string b, out int c, out byte d) { throw new NotImplementedException(); }
        public bool SetUserVerifyStyleBatch(int a, string b, ref byte c) { throw new NotImplementedException(); }
        public bool GetUserVerifyStyleBatch(int a, out string b, int c, out byte d) { throw new NotImplementedException(); }
        public bool GetDeviceFirmwareVersion(int a, ref string b) { throw new NotImplementedException(); }
        public bool SendFileEx(int a, string b, string c) { throw new NotImplementedException(); }
        public bool UploadTheme(int a, string b, string c) { throw new NotImplementedException(); }
        public bool UploadPicture(int a, string b, string c) { throw new NotImplementedException(); }
        public bool DeletePicture(int a, string b) { throw new NotImplementedException(); }
        public bool DownloadPicture(int a, string b, string c) { throw new NotImplementedException(); }
        public bool TurnOffAlarm(int a) { throw new NotImplementedException(); }
        public bool CloseAlarm(int a) { throw new NotImplementedException(); }
        public bool SSR_SetWorkCodeEx(int a, string b, string c) { throw new NotImplementedException(); }
        public bool SSR_GetWorkCodeEx(int a, string b, out string c) { throw new NotImplementedException(); }
        public bool SSR_DeleteWorkCodeEx(int a, string b) { throw new NotImplementedException(); }
        public bool SSR_GetGeneralLogDataEx(int a, out string b, out int c, out int d, out int e, out int f, out int g, out int h, out int i, out int j, out string k) { throw new NotImplementedException(); }
        public bool SSR_SetWorkCodeExBatch(int a, string b) { throw new NotImplementedException(); }
        public bool SSR_GetWorkCodeExBatch(int a, out string b, int c) { throw new NotImplementedException(); }
        public bool SSR_GetWorkCodeExByID(int a, int b, out string c, out string d) { throw new NotImplementedException(); }
        public bool SSR_GetWorkCodeIDByName(int a, string b, out int c) { throw new NotImplementedException(); }
        public bool SetEventMode(int a) { throw new NotImplementedException(); }
        public bool GetAllSFIDName(int a, out string b, int c, out string d, int e) { throw new NotImplementedException(); }
        public bool SetShortkey(int a, int b, string c, string d, int e, int f, string g, string h, int i, string j) { throw new NotImplementedException(); }
        public bool GetShortkey(int a, int b, ref string c, ref string d, ref int e, ref int f, ref string g, ref string h, ref int i, ref string j) { throw new NotImplementedException(); }
        public bool GetAllAppFun(int a, out string b, out string c) { throw new NotImplementedException(); }
        public bool GetAllRole(int a, out string b) { throw new NotImplementedException(); }
        public bool GetAppOfRole(int a, int b, out string c) { throw new NotImplementedException(); }
        public bool GetFunOfRole(int a, int b, out string c) { throw new NotImplementedException(); }
        public bool SetPermOfAppFun(int a, int b, string c, string d) { throw new NotImplementedException(); }
        public bool DeletePermOfAppFun(int a, int b, string c, string d) { throw new NotImplementedException(); }
        public bool IsUserDefRoleEnable(int a, int b, out bool c) { throw new NotImplementedException(); }
        public bool SearchDevice(string a, string b, out string c, int d) { throw new NotImplementedException(); }
        public bool SetUserIDCardInfo(int a, string b, ref byte c, int d) { throw new NotImplementedException(); }
        public bool GetUserIDCardInfo(int a, string b, out byte c, ref int d) { throw new NotImplementedException(); }
        public bool DelUserIDCardInfo(int a, string b) { throw new NotImplementedException(); }
        public bool GetPhotoByNameToFile(int a, string b, string c) { throw new NotImplementedException(); }
